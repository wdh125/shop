...
class AuthControllerTest {
    ...
    void setUp() {
        ...
        registerRequest.setPhoneNumber("0901234567");
        ...
        refreshTokenResponse.setRefreshToken("new-refresh-token");
    ...
    void testLogout_InvalidToken() throws Exception {
        when(authService.logout("mock-refresh-token"))
                .thenThrow(new RuntimeException("Invalid refresh token"));
    ...
    void testRegister_InvalidEmail() throws Exception {
        ...
        invalidRequest.setPhoneNumber("0901234567");
    ...
    void testRegister_WeakPassword() throws Exception {
        RegisterRequestDTO invalidRequest = new RegisterRequestDTO();
        invalidRequest.setUsername("testuser");
        invalidRequest.setPassword("123"); // Weak password
